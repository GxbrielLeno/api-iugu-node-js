...
async function adicionarDadosAluno(req, res) {
  try {
    ...
    const range = 'Sheet1!A2'; // Ajuste o intervalo conforme necessário

    // Monta o corpo da requisição
    const valores = [
      [iuguId, nomeAluno, sobrenomeAluno, emailAluno, telefoneAluno, cpfAluno, nomeCurso, valorCursoCentavos, CEP, bairro, cidade, estado, numero, endereco, new Date().toLocaleDateString('pt-BR'), formaDePagamento, formaIngresso, 'Pagamento Pendente']
    ];
...
setInterval(verificarFaturasRoute, 50000);
